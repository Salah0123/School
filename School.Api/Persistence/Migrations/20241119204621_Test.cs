    ...
    public partial class Test : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GradesGradeId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    SubjectsSubjectId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GradeSubject", x => new { x.GradesGradeId, x.SubjectsSubjectId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GradeSubject_Subjects_SubjectsSubjectId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LessonResources", x => x.ResourceId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GradeSubject_SubjectsSubjectId",
                table: "GradeSubject",
